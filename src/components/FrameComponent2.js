              ...
              <div className="frame-wrapper2">
                <div className="swap-100s-of-tokens-with-tools-parent">
                  <h1 className="swap-100s-of-container">
                    ...
                    <p className="with-tools-built">{`with tools built to `}</p>
                    <p className="perform-including">{`perform, including `}</p>
                    <p className="snipe-and-copytrades">snipe and copytrades</p>
                  ...
                  <img
                    className="cc-efa206e71-3-icon"
                    loading="lazy"
                    alt=""
                    src="/cc-efa206e71-3@2x.png"
                  />
                  <img
                    className="cc-efa206e71-4-icon"
                    loading="lazy"
                    alt=""
                    src="/cc-efa206e71-4@2x.png"
                  />
                </div>
              </div>
                  ...
                  <div className="image-holder">
                    <h1 className="enjoy-group-chats-container">
                      <p className="enjoy-group">
                        ...
                        <span>Enjoy group</span>
                      </p>
                      <p className="chats-and-spread">
                        chats and spread the memes!
                      </p>
                    </h1>
                  </div>
                </div>
